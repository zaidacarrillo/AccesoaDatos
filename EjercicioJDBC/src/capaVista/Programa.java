...
public class Programa {
	...
	public static void main(String[] args) {
		...
		ArrayList<Asignatura>listaAsignaturas3 = new ArrayList();
		listaAsignaturas.add(new Asignatura("PROGRAMACIÓN22",200,cicloPrueba3.getId()));
		listaAsignaturas.add(new Asignatura("PSP22",200,cicloPrueba3.getId()));
		listaAsignaturas.add(new Asignatura("INTERFACES22",200,cicloPrueba3.getId()));
